...
export const ProductCard = ({product}) => {
    ...
    return (
        ...
        <div className={`productCard__container__image`}>
            <img loading="lazy" className='primary__image' src={product.frontImage.url} alt={`${product.frontImage.title}`} name={`${product.frontImage.title}`}/>
            {
                productHasBackImage &&
                <>
                    <img className="secondary__image" loading="lazy" src={product.backImage.url} alt={`${product.backImage.title}`} name={`${product.backImage.title}`}/>
        ...
        <div className="contacto">
            ...
            <a href={`https://api.whatsapp.com/send?phone=573226330880&amp;text=Hola%20me%20interesa%20la%prenda%20${product.name},%20%C2%BFpodr%C3%ADas%20darme%20m%C3%A1s%20informaci%C3%B3n?`} target="_blank" rel="noopener" alt="Enlace a Whatsapp" name="Enlace a Whatsapp">
